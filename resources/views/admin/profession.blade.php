    ...
    <div class="page-wrapper cardhead">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">PROFESSION</h3>
                        <ul class="breadcrumb">
                ...
                <div class="page-btn">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#addProfesi" class="btn btn-added"><img
                            src="assets/img/icons/plus.svg" alt="img" class="me-1">Add Profession</a>
                </div>
            </div>
            <!-- /Page Header -->
            @if ($errors->any())
                        ...
                        <table class="table  datanew">
                            ...
                            <tbody>
                                @foreach ($listprofession as $item)
                                        ...
                                        <td>
                                            <a class="me-3" href="#">
                                                <img src="{{ asset('assets') }}/img/icons/edit.svg" alt="img"
                                                    ...
                                                    data-bs-target="#editProfession{{ $item->id }}"
                                    ...
                                    <!-- MODAL EDIT USERS -->
                                    @include('admin.editpage.edit-profession')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">PROFESSION INPUT FORM</h4>
