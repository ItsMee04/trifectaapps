...
@section('title', 'Purchase Suplier')
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Purchase Suplier</li>
                        </ul>
                    </div>
                </div>
                <div class="page-btn">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="purchase-supplier" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="select form-control form-white" name="supplier" required>
                                <option disabled selected hidden> Pilih Supplier</option>
                                @foreach ($listsupplier as $itemsuplier)
                                    <option value="{{ $itemsuplier->id }}">
                                        {{ $itemsuplier->suppliername }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="row">
