    ...
    <div class="page-wrapper cardhead">
        <div class="content">
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#addSupplier" class="btn btn-added"><img
                            src="assets/img/icons/plus.svg" alt="img" class="me-1">Add Supplier</a>
                </div>
            </div>
            <!-- /Page Header -->
            @if ($errors->any())
                        ...
                        <table class="table  datanew">
                            ...
                            <tbody>
                                @foreach ($listsupplier as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="confirm-text" href="javascript:void(0);"
                                                onclick="confirm_modal('supplier/{{ $item->id }}');">
                                    ...
                                    <!-- MODAL EDIT USERS -->
                                    @include('admin.editpage.edit-supplier')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-white" name="suppliercontact" placeholder="Masukan Kontak Supplier" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
